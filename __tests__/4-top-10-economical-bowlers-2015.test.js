...
const calculateTopEconomicalBowlersIn2015 = require('../src/server/4-top-10-economical-bowlers-2015');
...
test('Returns the top 10 economical bowlers in 2015', () => {
  expect(
    calculateTopEconomicalBowlersIn2015(matchesTest, deliveriesTest),
  ).toEqual(expected);
});
